...
def text_objseg_cls(text_seq_batch, im_batch, num_vocab, embed_dim,
    ...
    # Local image feature
    feat_vis = vgg_net.vgg_fc8_full_conv(im_batch, 'vgg_local',
    ...
    print("Language features: ", feat_lang.get_shape())
    print("Visual features: ", feat_vis.get_shape())
    ...
    feat_all = tf.concat(axis=3, values=[tf.nn.l2_normalize(feat_lang, 3),
                                         tf.nn.l2_normalize(feat_vis),])

    print("Concatenated features: ", feat_all.get_shape())
